...
namespace NSE.Identity.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Sigin(UserLogin model)
        {
            if (!ModelState.IsValid) return CustomResponse(ModelState);
        ...
        private async Task<object> GerarJwt(string email)
        {
            ...
            return GetTokeResponse(encodedToken, user, claims);
        }
        ...
        private async Task<ClaimsIdentity> GetUserClaims(ICollection<Claim> claims, IdentityUser user)
        {
            ...
            claims.Add(new Claim(JwtRegisteredClaimNames.Sub, ToUnixEpochDate(DateTime.UtcNow).ToString()));
        ...
        private UserLoginResponse GetTokeResponse(string encodedToken, IdentityUser user, IEnumerable<Claim> claims)
        {
